...
public class ReportUtil extends DriverScript {
    ...
    public static void startTesting(String filename, String testStartTime, String env, String rel, String Host, String browser,
	    String testSiteUrl) {
	...
	try {
	    ...
	    out.write(
		    "<td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>" + RUN_DATE + "</b></td>\n");
	    out.write("</tr>\n");
	    out.write("<tr>\n");
	    ...
	    out.write(
			    "<td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Execution Host</b></td>\n");
		    out.write("<td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>" + Host
			    + "</b></td>\n");
		    out.write("</tr>\n");

	    out.write(
		    "<td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Browser</b></td>\n");
	    out.write("<td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>" + Browser
		    + "</b></td>\n");
	    out.write("</tr>\n");

	    out.write(
		    "<td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Application URL</b></td>\n");
	    out.write("<td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>" + testSiteURL
		    + "</b></td>\n");
	    out.write("</tr>\n");
	    out.write("</table>\n");
	    
	    // Initializing Extent reports 
	    extent.setSystemInfo("Test Env ", ENVIRONMENT);
	    extent.setSystemInfo("Release ", RELEASE);
	    extent.setSystemInfo("Host ", Host);
	    extent.setSystemInfo("Browser ", Browser);
	    extent.setSystemInfo("App URL ", testSiteURL);
	    
	    reporter.config().setDocumentTitle("Extent Report Demo");
	    reporter.config().setReportName("Demo Auto");
	     ...
	     * 
	     * out.
	     * write("<h4> <FONT COLOR=660000 FACE= Arial  SIZE=4.5> Detailed Report :</h4>"
	     * ); out.write("<table  border=1 cellspacing=1 cellpadding=1 >");
	     * out.write("<tr>"); out.
	     * write("<td width=80  align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Test Script#</b></td>"
	     * );
	     * 
	     * out.
	     * write("<td width=300 align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Test Case Name</b></td>"
	     * ); out.
	     * write("<td width=75 align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Status</b></td>"
	     * ); out.
	     * write("<td width=200 align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Run End Time</b></td>"
	     * ); out.write("</tr>");
	     */
	...
	try {
		...
		if (description != null) {
			...
			if (teststatus.get(i).startsWith("Pass"))
			    out.write(
				    "<td width=20% align= center  bgcolor=#BCE954><FONT COLOR=#153E7E FACE=Arial SIZE=2><b>"
					    + teststatus.get(i) + "</b></td>\n");
			else if (teststatus.get(i).startsWith("Fail"))
			    out.write(
				    "<td width=20% align= center  bgcolor=Red><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>"
					    + teststatus.get(i) + "</b></td>\n");
			...
			if (screenShotPath.get(i) != null)
			    out.write("<td align=center width=20%><FONT COLOR=#153E7E FACE=Arial SIZE=1><b><a href="
				    + screenShotPath.get(i) + " target=_blank>Screen Shot</a></b></td>");
			// out.write("<td align=center width=20%><FONT
			// COLOR=#153E7E FACE=Arial SIZE=1><b><a
			// href=file///"+screenShotPath.get(i)+"
	    ...
	    out.write("<td width=10% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>" + scriptNumber
		    + "</b></td>\n");
	    // System.out.println(currentDir + "//" + currentSuiteName + "_TC" +
		...
		out.write("<td width=40% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b><a href="
			+ currentSuiteName + "_TC" + tcid + "_" + testCaseName.replaceAll(" ", "_") + ".html>"
			+ testCaseName + "</a></b></td>\n");
