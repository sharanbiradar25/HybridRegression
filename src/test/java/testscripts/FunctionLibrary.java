...
public class FunctionLibrary extends DriverScript {
	...
	public static String f = "FL";

	// function to Generate a date 10 days from today
	public static String futureDateGenerator() {
	...
	public static String uncheckCheckBox(By locator, String elemName) {
		...
		AppLog("Unchecking the checkbox : " + elemName);
	...
	public static String verifyTextPresent(String expText) {
		...
		AppLog("Verifying Text : '" + expText + "' " + "present in the Page Source");
		...
		try {
			...
			// Log result
			AppLog("'" + expText + "' present in the Page Source");
	...
	public static String clickLink(By locator, String elemName) {
		...
		try {
			...
			// Log error
			AppLog("Error while clicking on - " + elemName + " : " + clickLinkException.getMessage());
	 ...
	 * if any exception occurs in between.
	 *
	 * @param parLoc   Parent Element locator
	...
	public static String clearField(By locator, String elemName) {
		...
		AppLog("Clearing field : " + elemName);
		...
		try {
			...
			// Log error
			AppLog("Error while clearing - " + elemName + " : " + clearFieldException.getMessage());
	...
	public static String input(By locator, String elemName, String Value) {
		...
		AppLog("Sending Values in : " + elemName);
		...
		try {
			...
			// Log result
			AppLog("Inputted '" + Value + "' text into : '" + elemName + "'");
			...
			// Log error
			AppLog("Error while inputting into - '" + elemName + "' : " + inputException.getMessage());
	...
	public static String assertText(String elemName, String actValue, String expValue) {
		...
		AppLog("Asserting text for : '" + elemName + "' where Expected text is '" + expValue + "' and Actual text is '"
				+ actValue + "'");
		...
		try {
			...
			// Log result
			AppLog("Successfully asserted text for : '" + elemName + "' where Expected text is '" + expValue
	...
	public static String assertCondition(String elemName, Boolean condition) {
		...
		AppLog("Asserting Condition for : " + elemName);
		...
		try {
			...
			// Log result
			AppLog("Successfully asserted condition for : " + elemName);
			...
			// Log error
			AppLog("Error while asserting Condition for - '" + elemName + "' : "
	...
	public static String closePopupWindow() throws InterruptedException {
		...
		try {
			...
			// Log error
			AppLog("Error while closing pop-up window : " + closePopUpException.getMessage());
	...
	public static String switchToDefaultWindow() throws InterruptedException {
		...
		AppLog("Switching to Default Window");
		...
		try {
			...
			// Log result
			AppLog("Switched to default window");
	...
	public static String switchToPopupWindow() throws InterruptedException {
		...
		AppLog("Executing switchToPopupWindow");
		...
		try {
			...
			// Log result
			AppLog("Switched to pop-up window");
	...
	public static String closeDriver() throws InterruptedException {
		...
		try {
			...
			if (CONFIG.getProperty("test_browser").equals("InternetExplorer")) {
				...
				AppLog("Killing IEDriverServer process");
				...
				/*
				 * // If failed to kill try once with this if (exitVal == -1) {
				 * 
				 * try {
				 * 
				 * WindowsUtils.killByName("IEDriverServer.exe");
				 * AppLog("Killed IEDriverServer process");
				 * 
				 * }
				 * 
				 * catch (WindowsRegistryException taskKillException) {
				 * AppLog("IE Driver Server already killed. Skipping ..."); }
				 * 
				 * }
				 * 
				 * else { AppLog("Killed IEDriverServer process"); }
				 */

			}

			// Log result
			AppLog("Closed the driver");
			...
			// Log error
			AppLog("Error came while closing driver : " + closeDriverException.getMessage());
	...
	public static String selectValueByVisibleText(By Locator, String Option, String elemName) {
		...
		AppLog("Selecting '" + Option + "' from : " + elemName);
		...
		try {
			...
			// Log result
			AppLog("Selected '" + Option + "' from : " + elemName);
			...
			// Log error
			AppLog("Error while Selecting Value from - '" + elemName + "' : " + selectValueException.getMessage());
	...
	public static String selectValueByIndex(By Locator, int index, String elemName) {
		...
		AppLog("Selecting value from : " + elemName);
		...
		try {
			...
			// Log result
			AppLog("Selected value from : " + elemName);
	...
	public static String retrieveText(By locator, String elemName) {
		...
		AppLog("Retrieving Text from : " + elemName);
		...
		try {
			...
			// Log result
			AppLog("Retrieved text : " + retrievedText);
	...
	public static String retrieveAttributeValue(By locator, String value, String elemName) {
		...
		AppLog("Getting Attribute '" + value + "'  Value from - " + elemName);
		...
		try {
			...
			// Log result
			AppLog("Got Attribute '" + value + "'  Value from : " + elemName + " : " + attributeValue);
			...
			// report error
			AppLog("Error while Getting Attribute '" + value + "' value from '" + elemName + "' : "
	...
	public static List<WebElement> createWebList(By locator, String elemName) {
		...
		AppLog("Creating WebList for : " + elemName);
		...
		try {
			...
			// Log error
			AppLog("Error while Creating WebList reference for '" + elemName + "' : "
	...
	public static List<WebElement> createWebList(By parentLoc, By childLoc, String elemName) {
		...
		try {
			...
			// Log result
			AppLog("Created WebList for : " + elemName);
	...
	public static void waitForNewWindow(int prevWndCount) {
		...
		try {
			...
			AppLog("Exception while waiting for new window to appear : " + waitForNewWindowException.getMessage());
		}
	...
	public static void waitForElementToLoad(final By locator) {
		...
		AppLog("Waiting for web element to load on the page");
		...
		try {
			...
			// Log result
			AppLog("Waiting ends ... Web element loaded on the page");
	...
	public static void waitForElementToDisappear(final By locator, String elemName) {
		...
		AppLog("Waiting for " + elemName + " to disappear ...");
		...
		try {
			...
			// Log result
			AppLog("Waiting ends ... " + elemName + " disappeared");
			...
			// Log error
			AppLog("Error came while waiting for element to disappear : " + waitForElementException.getMessage());
	...
	public static boolean verifyNumber(String elemName, int actValue, int expValue) {
		...
		AppLog("Verifying Number for : " + elemName);
		...
		try {
			...
			// Log result
			AppLog("Actual value '" + actValue + "' matches with Expected value '" + expValue + "' for : " + elemName);
			...
			// Log error
			AppLog("Error while Verifying Number for '" + elemName + "' : " + verifyNumberException.getMessage());
	...
	public static String acceptAlert(String elemName) {
		...
		AppLog("Accepting alert : " + elemName);
		...
		try {
			...
			// Log result
			AppLog("Accepted alert : " + elemName);
			...
			// Log error
			AppLog("Error came while accepting alert : " + acceptAlertException.getMessage());
	...
	public static String clickAndWait(By locator, String elemName) {
		...
		try {
			...
			// Log result
			AppLog("Clicked on the element : " + elemName + " and new page loaded with title : " + driver.getTitle());
			...
			// Log error
			AppLog("Error while clicking on " + elemName + " and waiting for new page to load : "
	...
	public static String assertTitle(String expectedTitle) {
		...
		AppLog("Asserting  title  where : Expected title = " + expectedTitle);
		...
		try {
			...
			// Log error
			AppLog("Error while asserting title : " + assertTitleException.getMessage());
	...
	public static String assertAlertAndAccept(String expectedAlertText) {
		...
		AppLog("Asserting alert text : " + expectedAlertText);
		...
		try {
			...
			// log result
			AppLog("Success : got the alert message saying : " + actualAlertText);
			...
			AppLog("Error came while asserting alert and accepting : " + alertExcpetion.getMessage());
	...
	public static void highlightElement(WebDriver driver, By Locator) {
		...
		if (highlightElement) {
			try {
				...
				AppLog("Error came : " + t.getMessage());
			}
		}
	...
	public static String checkCheckBox(By locator, String elemName) {
		...
		try {
			...
			if (!driver.findElement(locator).isSelected()) {
				...
				AppLog(elemName + " is already checked");
			...
			AppLog("Error while checking -" + elemName + checkCheckBoxException.getMessage());
	...
	public static Boolean assertPartialText(String elemName, String expValue, String actValue) {
		...
		AppLog("Asserting Partial Text for: " + elemName);
		...
		try {
			...
			if (check) {
				...
				AppLog("Expected text - " + expValue + " is found to be present within Actual text - " + actValue
						+ " for : " + elemName);
				return true;
				...
				AppLog("Expected text : " + expValue + " is not present within Actual text : " + actValue + " for - "
						+ elemName);
				return false;
			...
			AppLog("Error while Verifying Partial Text for : " + elemName + assertPartialTextException.getMessage());
			return false;
	...
	public static void inputInteger(By locator, String elemName, int Value) {
		...
		try {
			...
			AppLog("Error while Sending Values in:  -" + elemName + t.getMessage());
		}
	...
	public static String getDateAndTimeOfSpecificTimeZone(String dateAndTimeFormat, String timeZone) {
		...
		AppLog("Getting date and time of specified time zone ...");
		...
		AppLog("Got date and time specific to timezone. Timezone = " + timeZone + " and DateTime = " + dateAndTime);
	...
	public static void maximizeWindow() {
		...
		AppLog("Maximizing the window ...");

		try {

			driver.manage().window().maximize();
			AppLog("Browser window successfully maximized");

		}

		catch (Throwable windowMaximizeException) {

			AppLog("Exception came while maximizing window : " + windowMaximizeException.getMessage());
	...
	public static void refreshPage() {
		...
		AppLog("Refreshing the page ...");

		try {

			driver.navigate().to(driver.getCurrentUrl());
			AppLog("Page successfully refreshed");

		}

		catch (Throwable pageRefreshException) {

			AppLog("Exception came while refreshing page : " + pageRefreshException.getMessage());
	...
	public static void selectValue(By Locator, String Value, String elemName) {
		...
		try {
			...
			AppLog("Error while Selecting Value from :   -" + elemName + e.getMessage());
		}

	}

	// Generate randomn characters
	public static String randomnGenerator(int count) {

		int PASSWORD_LENGTH = count;
	...
	public static Boolean isChecked(By locator, String elemName) {
		...
		AppLog("Verifying is the checkbox checked : " + elemName);
		...
		try {
			...
			if (isChecked) {
				// Log the result
				AppLog("'" + elemName + "' is checked");
			} else {
				// Log the result
				AppLog("'" + elemName + "' is not checked");
			}
			return isChecked;
			...
			// Log the exception
			AppLog("Error while verifying checkbox is checked '" + elemName + "' : "
	...
	public static String scrollWebPage(int pixelToScrollHorizontally, int pixelToScrollVertically) {
		...
		AppLog("Scrolling through web page ... ");
		...
		AppLog("Scrolled through web page");
	...
	public static String divScrollerRight(String ID, String elemName) {
		...
		AppLog("Horizontal right scroll inside DIV : " + elemName);
		...
		try {
			...
			// Log the exception
			AppLog("Error while scrolling horizontally towards right: '" + elemName + "' : "
	...
	public static Date convertStringToDate(String dateString, String dateFormat) {
		...
		AppLog("Converting string to date format ...");
		...
		try {
			...
			// Log error
			AppLog("Error while converting String to Date format : " + convertStringToDateException.getMessage());
	...
	public static Boolean compareDates(Date date1, Date date2, String elemName) {
		...
		Boolean result = null;
		AppLog("Comparing dates : " + elemName);
		...
		try {
			...
			// Log error
			AppLog("Error while comparing dates '" + elemName + "' : " + compareDates.getMessage());
	...
	public static String getFormattedDate(DateFormat dateFormat) {
		...
		AppLog("Got formatted date : " + currentSystemDate);
	...
	public static String getFormattedDate(DateFormat dateFormat, int dayCount) {
		...
		if (dayCount < 0) {
			AppLog("Getting date of " + (-dayCount) + " days before ...");
		} else if (dayCount == 0) {
			AppLog("Getting current system date ...");
		} else {
			AppLog("Getting date of " + dayCount + " days after ...");
		}
		...
		AppLog("Got formatted date : " + formattedDate);
	...
	public static String retrieveCSSValue(By locator, String value, String elemName) {
		...
		AppLog("Getting CSS '" + value + "'  Value from - " + elemName);
		...
		try {
			...
			// Log result
			AppLog("Got Attribute '" + value + "'  Value from : " + elemName + " : " + cssValue);
			...
			AppLog("Error while Getting CSS '" + value + "' value from '" + elemName + "' : "
	...
	public static int compareDates(String firstDate, String secondDate) {
		...
		AppLog("Comparing first date : " + firstDate + " and second date : " + secondDate + " ...");
		...
		try {
			...
			AppLog("Error came while comparing first date : " + firstDate + " and second date : " + secondDate + " - "
					+ errorInDateComparison.getMessage());
	...
	public static Boolean compareLists(List<String> firstList, List<String> secondList) {
		...
		if (result) {
			AppLog("First list is : " + firstList + " , Second list is : " + secondList + " and they are equal");
		} else {
			AppLog("First list is : " + firstList + " , Second list is : " + secondList + " and they are NOT equal");
		}
	...
	public static void assignIdAttributeToWebElement(By locator, String elemName, String Id) {
		...
		AppLog("Assigning ID attribute to " + elemName + " ...");
		...
		try {
			...
			AppLog("Error came while assigning ID to the element : " + assignIdException.getMessage());

		}

		AppLog("Assigned ID attribute to " + elemName);
	 ...
	 * @param locator                   Element locator
	 * @param elemName                  Element name
	 * @param pixelToScrollVertically   Pixel to scroll vertically
	 * @param pixelToScrollHorizontally Pixel to scroll horizontally
	 *
	 * @return void
	 */
	...
	public static void scrollWithinParticularElement(By locator, String elemName, int pixelToScrollVertically,
		...
		AppLog("Scrolling within " + elemName + " ...");
		...
		try {
			...
			AppLog("Error came while scrolling within the element : " + scrollException.getMessage());

		}

		AppLog("Scrolled within " + elemName);
	...
	public static String getBrowserInfo() {
		...
		try {
			...
			AppLog("Got browser info : " + browserInfo);

		}

		catch (Throwable browserInfoError) {

			AppLog("Error came while getting browser info : " + browserInfoError.getMessage());
	...
	public static String getBrowserName() {
		...
		AppLog("Got browser name : " + browserName);
	...
	public static String getBrowserVersion() {
		...
		AppLog("Getting browser version ...");
		...
		AppLog("Got browser version : " + browserVersion);
	...
	public static String getPageTitle() {
		...
		AppLog("Getting current webpage title ...");
		...
		try {
			...
			AppLog("Error came while fetching page title : " + getPageTitleError.getMessage());

		}

		AppLog("Got current webpage title : " + pageTitle);
		return pageTitle;
	...
	public static String getCurrentUrl() {
		...
		try {
			...
			AppLog("Error came while getting current Url : " + getCurrentUrlError.getMessage());

		}

		AppLog("Got current URL : " + currentUrl);
		return currentUrl;
	...
	public static String loadUrl(String url) {
		...
		try {
			...
			AppLog("Error came while loading Url : " + loadingUrlError.getMessage());

			return "Fail : Error came while loading Url : " + loadingUrlError.getMessage();

		}

		AppLog("Url successfully loaded");
	...
	public static Boolean isElementPresent(By locator, String elemName) {
		...
		AppLog("Checking whether " + elemName + " is present on the page or not ...");
		...
		try {
			...
			AppLog(elemName + " is present on the page");
			return true;
			...
			AppLog(elemName + " not present on the page");
			return false;
	...
	public static Boolean isElementDisplayed(By locator, String elemName) {
		...
		AppLog("Checking whether " + elemName + " is displayed on the page or not ...");
		...
		try {
			...
			if (isDisplayed) {
				AppLog(elemName + " is displayed on the page");
			} else {
				AppLog(elemName + " not displayed on the page");
			}
	...
	public static void AppLog(String elemName) {

		// Extent reports log
		eLog(elemName);

		// application log
		APPLICATION_LOGS.debug(elemName);

	}

	public static void log(String elemName) {
		...
		/*
		 * if (isRemote.contentEquals("true") || isRemote.equals("True")) {
		 * System.out.println(elemName); }
		 */
	}

	// Extent Reports Logging
	public static void eLog(String elemName) {

		if (elemName.startsWith("Error")) {
			logger.log(Status.ERROR, elemName);
		} else if (elemName.startsWith("Fail")) {
			logger.log(Status.FATAL, elemName);
		} else {
			logger.log(Status.INFO, elemName);
		}
	...
	public static Boolean isElementEnabled(By locator, String elemName) {
		...
		AppLog("Checking whether " + elemName + " is enabled on the page or not ...");
		...
		try {
			...
			if (isEnabled) {
				AppLog(elemName + " is enabled on the page");
			} else {
				AppLog(elemName + " not enabled on the page");
			}
	...
	public static boolean isClickable(By element, String elementName) {
		try {
			WebDriverWait wait = new WebDriverWait(driver, 5);
			wait.until(ExpectedConditions.elementToBeClickable(element));
			AppLog(elementName + " is Clickable & Visible");
			return true;
		} catch (Exception e) {
			AppLog(elementName + " is NOT Clickable");
			return false;
		}
	}
	...
	public static Boolean isElementSelected(By locator, String elemName) {
		...
		AppLog("Checking whether " + elemName + " is selected on the page or not ...");
		...
		try {
			...
			if (isSelected) {
				AppLog(elemName + " is selected on the page");
			} else {
				AppLog(elemName + " not selected on the page");
			}
	...
	public static Boolean compareListsWithPreservedOrder(List<String> firstList, List<String> secondList) {
		...
		AppLog("Comparing two lists whether in the same order ...");
	...
	public static String getNextOrPreviousDate(String startDate, int days, String dateFormat) throws ParseException {
		...
		try {
			...
			AppLog("Error came while getting next or previous date : " + dateException.getMessage());

		}

		AppLog("New date After addition or substarction of Days : " + dateFormat);
	...
	public static String moveToWebElement(By locator, String elemName) {
		...
		try {
			...
			AppLog("Error came while moving to : " + moveToElementException.getMessage());
	...
	public static String switchToiFrame(By locator, String elemname) {
		try {
			...
			waitForElementToLoad(locator);
			// Switch to iframe
			AppLog("Switching to " + elemname + ": iframe ....");
			driver.switchTo().frame(driver.findElement(locator));

			AppLog("Switched to " + elemname + ": iframe ....");
			return "Pass : switch to " + elemname + ": iframe ";
		} catch (Throwable SwitchToFrameException) {
			AppLog("Error came while switching to " + elemname + ": iframe");
	...
	public static String switchToAlert() throws InterruptedException {
		...
		try {
			...
			// Log error
			AppLog("Error while switching to alert : " + switchToAlertException.getMessage());
	...
	public static String dismissAlert(String elemName) {
		...
		AppLog("Dismissing alert : " + elemName);
		...
		try {
			...
			// Log result
			AppLog("Dismissed alert : " + elemName);
			...
			// Log error
			AppLog("Error came while dismissing alert : " + dismissAlertException.getMessage());
	...
	public static String getAlertText() {
		...
		AppLog("Getting text of the alert ...");
		...
		try {
			...
			AppLog("Error came while fetching alert text : " + getAlertTextError.getMessage());

		}

		AppLog("Got text of alert : " + alertText);
		return alertText;
	...
	public static int extractNumberFromString(String stringWithNumbers) {
		...
		AppLog("Extracting Number from the String ...");
		...
		try {
			...
			// Log result
			AppLog("Integer retreived : " + integerInString);
			...
			// Log error
			AppLog("Error while converting String to int format : " + extractNumberFromStringException.getMessage());
	...
	public static String[] extractAllTextFromWebTable(By locator) {
		...
		AppLog("Extracting text from web table ...");
		...
		try {
			...
			// Log result
			AppLog("Text from the web table retrieved ");
			...
			// Log error
			AppLog("Error while retrieving the text from web table : "
	...
	public static long getMinuteDifference(String date1, String date2, String dateFormat) {
		...
		AppLog("Get the minute difference from two date strings ...");
		...
		try {
			...
			// Log result
			AppLog("Minute difference : " + minutes);
			...
			// Log error
			AppLog("Error while getting the difference from two date strings : "
	...
	public static Date subtractDate(int dateDiff) {
		...
		AppLog("Get the date difference  ...");
		...
		try {
			...
			// Log result
			AppLog("Date difference : " + newDate);
	...
	public static String driver2ClickAndWait(By locator, String elemName) {
		...
		try {
			...
			// Log result
			AppLog("Clicked on the element : " + elemName + " and new page loaded with title : " + driver2.getTitle());
	...
	public static Date addDate(int daysToAdd) {
		...
		AppLog("Get the date after adding  ...");
		Date newDate = new Date();
		...
		try {
			...
			// Log error
			AppLog("Error while getting the difference of date : " + addDateException.getMessage());
	...
	public static Date subtractDaysFromDate(Date Dischargedate, int dateDiff) {
		...
		AppLog("Subtarcting " + dateDiff + " from " + Dischargedate + "...");
		Date newDate = new Date();
		...
		try {
			...
			// Log result
			AppLog("Date after subtracting " + dateDiff + " from " + Dischargedate + " : " + newDate);
	...
	public static String getTableRowCount(By locator, String elemName) {
		...
		AppLog("Getting count of rows in table : " + elemName);
		int count = 0;

		try {
			count = driver.findElements(locator).size();
		} catch (Throwable tableCountException) {
			AppLog("Unable to get the count of rows in table.");
	...
	public static Date addDate(Date date, int daysToAdd) {
		...
		try {
			...
			// Log error
			AppLog("Error while adding days to passed date : " + addDateException.getMessage());
